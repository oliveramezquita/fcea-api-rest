...
urlpatterns = [
    ...
    path('public-user/<str:user_id>',
         views.PublicUserView.as_view(), name="public-user"),
    ...
    path('reset-password', views.ResetPasswordOutsideView.as_view(),
         name="reset-password"),
    path('reset-password-inside', views.ResetPasswordInsideView.as_view(),
         name='reset-password-inside-view'),
